...
// import SquareWOFF from "../assets/fonts/TitilliumWeb-Regular.ttf";
// import SquareBoldWOFF from "../assets/fonts/TitilliumWeb-Bold.ttf";
// import SquareSemiBoldWOFF from "../assets/fonts/TitilliumWeb-SemiBold.ttf";
// import SquareItalicWOFF from "../assets/fonts/TitilliumWeb-Italic.ttf";
// import SquareLightWOFF from "../assets/fonts/TitilliumWeb-Light.ttf";
// import SquareMediumWOFF from "../assets/fonts/TitilliumWeb-ExtraLight.ttf";

import TitilliumWebBOLD from "../assets/fonts/TitilliumWeb-Bold.ttf";
import TitilliumWebRegular from "../assets/fonts/TitilliumWeb-Bold.ttf";
...
const square = {
  ...
  src: `
		...
		url(${TitilliumWebRegular}) format('woff')
	`,
  unicodeRange:
...
const squareSemiBold = {
  ...
  src: `
		...
		local('EuclidSquare-SemiBold'),
		url(${TitilliumWebBOLD}) format('woff')
	`,
  unicodeRange:
    "U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF",
};
