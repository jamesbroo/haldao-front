          ...
          <Grid className="calculator-card-grid" container direction="column" spacing={2}>
            <Grid item>
              <Box className="card-header">
                <Typography variant="h5">Ask The Oracle</Typography>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6} sm={4} md={4} lg={4}>
                    <Box className="calculator-card-tvl">
                      ...
                      <Typography
                        variant="h4"
                        style={{ fontWeight: "600", "word-break": "break-all", "white-space": "break-spaces" }}
                      >
                        {isAppLoading ? (
                  ...
                  <Grid item xs={6} sm={4} md={4} lg={4}>
                    <Box className="calculator-card-index">
                      ...
                      <Typography variant="h4" style={{ fontWeight: "600" }}>
                        {isAppLoading ? <Skeleton width="100px" /> : <>{trimmedsHecBalance} sHAL</>}
                      </Typography>
                    </Box>
                  </Grid>
                </Grid>
            ...
            <Box className="calculator-card-area">
              <Box>
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                      <Box className="calculator-card-action-area-inp-wrap">
                        <Typography variant="h6">sHAL Amount</Typography>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                    ...
                    <Grid item xs={12} sm={6}>
                      <Box className="calculator-card-action-area-inp-wrap">
                        <Typography variant="h6">HAL price at purchase ($)</Typography>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                          className="calculator-card-action-input"
                    ...
                    <Grid item xs={12} sm={6}>
                      <Box className="calculator-card-action-area-inp-wrap">
                        <Typography variant="h6">Future HAL market price ($)</Typography>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                          className="calculator-card-action-input"
                ...
                <Box className="calculator-user-data">
                  ...
                  <Box className="data-row">
                    <Typography>HAL rewards estimation</Typography>
                    <Typography>{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} HAL</>}</Typography>
                  </Box>
                  <Box className="data-row">
                  ...
                  <Box className="data-row">
                    <Typography>Potential number of Lamborghini Huracán EVO RWDs</Typography>
                    <Typography>
                      {isAppLoading ? <Skeleton width="80px" /> : <>{Math.floor(Number(potentialReturn) / 208571)}</>}
                    </Typography>
                  </Box>
                </Box>
              </Box>
