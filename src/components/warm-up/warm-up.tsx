    ...
    <div className={"warm-up MuiPaper-root ohm-card "}>
      <>
        <div className="card-header header">
          <div className="title">
            <Typography variant="h5">TRP Deposit - First 24-Hour (Stake)</Typography>
            <RebaseTimer />
          </div>

          <Tooltip
            arrow
            title="Choosing to Forfeit will return your original TRP amount without any of the accumulated rewards for the first 3 rebases."
        ...
        <div className={"details "}>
          <div className={"initial-amount"}>
            <div className="MuiTypography-body1">Initial Balance</div>
          ...
          <div className={"claim-forfeit"}>
            {warmupRebaseTime >= 1 ? (
              ...
              >
                {txnButtonText(pendingTransactions, "claiming", "Claim & Deposit")}
              </Button>
            )}
          </div>
        </div>
